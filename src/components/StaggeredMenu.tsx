...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div className="sm-scope w-full h-full" suppressHydrationWarning>
      <div
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-4 bg-transparent pointer-events-auto z-20"
                ...
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      ...
                      href={it.link}
                      onClick={(e) => handleMenuItemClick(it.link, e)}
      ...
      <style>{`
.sm-scope .staggered-menu-wrapper { position: relative; width: 100%; height: 64px; z-index: 40; }
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 1rem; background: transparent; pointer-events: auto; z-index: 20; }
