...
export default function NavBar({ theme, onToggleTheme, onToggleCode, codeOpen }) {
  ...
  const brandSrc = theme === "dark" ? "/naman-avatar-dark.png" : "/naman-avatar-light.png"

  return (
    <header suppressHydrationWarning className="fixed inset-x-0 top-0 z-[100]">
