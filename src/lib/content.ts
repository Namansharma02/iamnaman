...
I believe innovation always beats excellence, because innovation redefines what excellence even means.`,
  ...
  experience: [
    { role: "Automation Manager", company: "JP Morgan Chase" },
    { role: "Executive MBA Student", company: "SPJIMR, Mumbai" },
    { role: "Business Technology Analyst", company: "Deloitte USI" }
  ]
}
...
export const experience = [
  {
    ...
    period: "2021 – Present",
    role: "Finance Automation Manager",
    summary: "Lead analytics, automation, and transformation initiatives across finance operations, working closely with senior stakeholders to define priorities, shape strategy, and drive scalable execution. Built dashboards, reconciliation tools, workflow automations, and integrated reporting solutions connecting platforms such as qTest, JIRA, and Confluence. Developed hands-on solutions using Alteryx, UiPath, Python, SQL, and Tableau across trade booking, ETL, reconciliation, and reporting. Automated multiple manual processes with 90–99% effort reduction, delivered scalable solutions used by 500+ global users, and improved operational visibility supporting stronger controls and faster decision-making.",
    roles: [
      {
        title: "Finance Automation Manager",
        period: "Aug 2025 – Present",
        duration: "8 mos",
        summary: "Lead analytics, automation, and transformation initiatives across finance operations, working closely with senior stakeholders to define priorities, shape strategy, and drive scalable execution.",
        details: "Directed automation, reporting, and process improvement programs across multiple streams using Python, Alteryx, Tableau, SQL, and APIs. Led teams, guided delivery, strengthened governance, and helped convert complex manual processes into structured and scalable solutions.",
        impact: "Improved operational visibility, increased efficiency, and delivered high-impact solutions that supported stronger controls, faster decision-making, and broader automation adoption across functions.",
        skills: ["Python", "Project Management", "Tableau", "SQL", "APIs", "Alteryx"]
      },
      {
        title: "Finance Automation Lead",
        period: "Mar 2023 – Aug 2025",
        duration: "2 yrs 6 mos",
        summary: "Led end-to-end automation and analytics delivery across key finance and operations initiatives, acting as the link between business requirements and technical execution.",
        details: "Built dashboards, reconciliation tools, workflow automations, and integrated reporting solutions by connecting platforms such as qTest, JIRA, and Confluence. Worked with cross-functional teams to ensure solutions were practical, scalable, and aligned to business needs.",
        impact: "Reduced manual effort, improved reporting speed and quality, and delivered scalable solutions used by 500+ global users while supporting critical transformation programs.",
        skills: ["Tableau", "Alteryx", "qTest", "JIRA", "Confluence", "Python", "SQL"]
      },
      {
        title: "Finance Automation Developer",
        period: "Jun 2021 – Feb 2023",
        duration: "1 yr 9 mos",
        summary: "Developed automation and reporting solutions to streamline manual work, improve process accuracy, and support operational teams with scalable tools.",
        details: "Built hands-on solutions using Alteryx, UiPath, Python, SQL, and Tableau across trade booking, ETL, reconciliation, reporting, and workflow automation. Created reusable frameworks and practical tools that could be maintained and expanded over time.",
        impact: "Automated multiple manual processes with 90% to 99% effort reduction, saved hours daily, and built strong technical foundations for future automation initiatives.",
        skills: ["Alteryx", "UiPath", "Python", "SQL", "Tableau", "ETL"]
      }
    ]
  },
  {
    ...
    summary: "Supported technology delivery, testing, and data validation across large business and public-sector systems in a consulting environment. Worked on test strategy, SQL data support, deployment readiness, defect validation, and data quality improvement across major initiatives, including critical COVID-related enhancements. Improved data accuracy, supported successful deployments, and earned multiple Applause Awards for consistent performance and contribution.",
    roles: [
      {
        title: "Business Technology Analyst",
        period: "Jul 2019 – Jun 2021",
        duration: "2 yrs",
        summary: "Supported technology delivery, testing, and data validation across large business and public-sector systems in a consulting environment.",
        details: "Worked on test strategy, SQL data support, deployment readiness, defect validation, and data quality improvement across major initiatives, including critical COVID-related enhancements. Contributed across coordination, execution, and issue resolution in fast-moving project environments.",
        impact: "Improved data accuracy, supported successful deployments, and earned multiple Applause Awards for consistent performance and contribution.",
        skills: ["SQL", "Test Strategy", "Data Validation", "Deployment"]
      }
    ]
  },
  {
    ...
    summary: "Pursuing Post Graduate Programme in General Management while working full-time, focusing on strategic management, financial analysis, operations research, and organizational leadership. Building cross-functional business acumen to complement technical expertise.",
    roles: [
      {
        title: "Executive MBA Student",
        period: "2024 – 2026",
        duration: "ongoing",
        ...
        details: "Pursuing executive education while working full-time, focusing on strategic management, financial analysis, operations research, and organizational leadership.",
        impact: "Building cross-functional business acumen to complement technical expertise.",
        skills: ["Strategy", "Finance", "Operations", "Leadership"]
      }
    ]
  }
]
...
export const appreciations = {
  headline: "Testimonials & Recognitions",
  items: [
    // ============================================
    // FEATURED TESTIMONIALS (First 4 - shown as full cards on main page)
    // ============================================
      {
      id: 1,
      company: "JPMorgan Chase",
      text: "Thanks Naman, for outstanding work and the real impact you're making on our team. A superb job on the **** automating, and followed it up with an even better performance on the **** automation POC. Your work has earned well-deserved recognition from the *** group and our MD *****, which speaks to the quality and value you're delivering. What makes this especially meaningful is the timing. During these challenging times, you have brought exactly the kind of progress and positive momentum we needed. You've demonstrated technical excellence, strong execution, and the ability to deliver solutions that truly matter. Naman, thank you for your dedication and exceptional contributions. Your work is making a real difference, and we're fortunate to have you on the team.",
    ...
    },
    {
      id: 3,
      company: "JPMorgan Chase",
      text: "Your exceptional work in developing automation solutions for over 500 **** users and the broader department has been phenomenal. The help with the Tableau dashboard setup for program, as well as your efforts in automating the trade booking of various brokerage products, is truly appreciated. Great work for IPB.",
      from: "K.T., Executive Director"
    },
    {
      id: 4,
      company: "JPMorgan Chase",
      text: "Hey Naman, We commenced quite unexpectedly as we found ourselves seated next to each other. Your expertise in Python, UiPath, and Alteryx is nothing sort of exceptional and your assistance has been invaluable in navigating through complex challenges. You have consistently been a reliable source of guidance and support. Your ability to dissect intricate problems and offer practical solutions is truly commendable. What sets you apart is not just your technical prowess but also your willingness to share insights from an expert perspective. Your valuable insights from my upcoming project were greatly appreciated. You exude professionalism in every interaction, display a demeanor that reflects dedication and a genuine eagerness to assist. Naman, you are truly a gem of a person and thank you so much for all the help and support that you provided me this far.",
      from: "A.B., Vice President"
    },
    {
      id: 5,
      company: "JPMorgan Chase",
      text: "Naman has done a fabulous job of bringing efficiency to the frontline. Not only he is contributing to his core project but also never shies away from taking additional responsibilities. I have reached out to him on multiple occasions & every time he has delivered. He manages to find time from his core BAU and deliver on the additional ask. Thank you Naman for all the good work and keep continuing.",
    ...
    },
	{
      id: 7,
      company: "JPMorgan Chase",
      text: "I'd like to recognize Naman for exceptional leadership during the ****-a-thon. He has been instrumental in coordinating our Fixed Income team, seamlessly connecting functional and automation people, and helping resolve technical questions quickly. His approachable style, steady guidance, and smooth coordination have enabled us to progress our automation goals efficiently. Thank you Naman, for leading the team so well and supporting us at every step.",
      from: "K.K., Associate"
    },
	{
      id: 8,
